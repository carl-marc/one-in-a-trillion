...
This, along with a large amount of changes to spawn rates for items, tripplies, etc, means that we have a multiplayer that now mixes skill & focus with a sprinkle of luck!
...
Unlike daily leagues, 1v1 battles will last up to 20 minutes & you can play multiple games per day.
